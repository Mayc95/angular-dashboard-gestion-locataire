...
import { ListLocatairesComponent } from './pages/locataires/list-locataires/list-locataires.component';
import { ListPaiementsComponent } from './pages/paiements/list-paiements/list-paiements.component';
import { AddLocataireComponent } from './pages/locataires/add-locataire/add-locataire.component';
import { AddPaiementComponent } from './pages/paiements/add-paiement/add-paiement.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'paiements',
        title: 'Liste des paiements de loyer',
        children: [
          {
            path: '',
